...
public class ToolboxTalk : TenantEntity
{
    ...
    /// <summary>URL of the source file uploaded for this learning (PDF or video).</summary>
    public string? SourceFileUrl { get; set; }

    /// <summary>Original filename of the uploaded source file.</summary>
    ...
    /// <summary>
    /// JSON array of ISO 639-1 target language codes for this learning
    /// (e.g. ["es","fr"]). Populated at Step 1 of the new wizard.
    /// </summary>
    public string? TargetLanguageCodes { get; set; }

    // Learning wizard audit metadata (new wizard, Step 1)

    /// <summary>Reviewer name for the audit report.</summary>
    public string? ReviewerName { get; set; }

    /// <summary>Reviewer organisation for the audit report.</summary>
    public string? ReviewerOrg { get; set; }

    /// <summary>Reviewer role for the audit report.</summary>
    public string? ReviewerRole { get; set; }

    /// <summary>Document reference code. Auto-generated by the server when not supplied.</summary>
    public string? DocumentRef { get; set; }

    /// <summary>Client name for the audit report.</summary>
    public string? ClientName { get; set; }

    /// <summary>Audit purpose description for the audit report.</summary>
    public string? AuditPurpose { get; set; }

    /// <summary>Target audience role (e.g. "Operator", "Supervisor", "Auditor").</summary>
    public string? AudienceRole { get; set; }

    /// <summary>
    /// When true, the AI generator should preserve source wording as closely
    /// as possible rather than paraphrasing.
    /// </summary>
