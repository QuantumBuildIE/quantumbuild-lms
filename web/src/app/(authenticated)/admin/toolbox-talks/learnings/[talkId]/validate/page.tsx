...
import { ValidateStep } from '@/features/toolbox-talks/components/learning-wizard/steps/ValidateStep';
...
export default function LearningWizardValidatePage() {
  ...
  const { reachableSteps, canGoBack, canGoNext, goBack, goNext, goToStep, isNavigating } =
    useStepNavigation({ talkId, currentStep: 6, talk: talk ?? null, validationRuns });
